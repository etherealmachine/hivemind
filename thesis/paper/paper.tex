...
% answer: yes
% DPH: the more I think about it the more I think I don't understand the comment.  Is it about representing MoGo patterns with the 
% pattern encodings, or about using mogo patterns as a comparator?
