...
%The choice of game and rules can also be experimentally varied to give a range of difficulty and computational complexity levels. 
...
%Go is a much older game than Hex, and much research has been done on Go playing algorithms. 
...
%It also constrains the space of games that can be easily implemented in Hivemind. 
...
%\item{Report on the status of the winner. The \texttt{Winner()} function is used to determine the current winner of the game. The special \texttt{Empty} player is returned while the game is in progress, and either \hblack{} or \hwhite{} once a winner has been determined.}
